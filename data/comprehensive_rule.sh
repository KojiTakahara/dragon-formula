...
q5 () {
  ...
  choice2=ダイスやコイントス、じゃんけんなど無作為の方法によって、その勝者が先攻か後攻かを選ぶ。
...
q9 () {
  content=カードテキストがいくつかのバージョンで異なる場合、原則、正とするのは次のうちどれか。
  choice1=最新のカード表記。
  choice2=最古のカード表記。
  choice3=ジャッジの裁量に従う。
...
q10 () {
  content=複数枚で構成されたクリーチャーの一部カードが場を離れるときの状態として、誤っているのは次のうちどれか。
  choice1=進化クリーチャーの下にあるカードが離れる場合、クリーチャーとして離れる。
  choice2=リンクしたゴッドの一部カードが離れる場合、クリーチャーとして離れる。
  choice3=サイキック・リンクしたクリーチャーの一部カードが離れる場合、サイキック・セルとして離れる。
  callAPI $content $choice1 $choice2 $choice3 "rule_1_1" "rule_1_1_109"
}
q11 () {
...
q24 () {
  content=ワールド・ブレイカーですべてのシールドをブレイクされる時の、シールド・セイバー能力として正しいのは、次のうちどれか。
  choice1=シールド・セイバーでブレイクされなかったシールドは、シールドゾーンに残る。
  choice2=すべてのシールドをブレイクする効果に対してシールド・セイバーは使えない。
...
q26 () {
  content=呪文能力によるクリーチャーに適用する継続的効果について誤っているのは、次のうちどれか。
...
q27 () {
  content=常在型能力によるクリーチャーに適用する継続的効果について誤っているのは、次のうちどれか。
